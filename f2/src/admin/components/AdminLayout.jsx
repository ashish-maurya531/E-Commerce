...
const AdminLayout = ({ children }) => {
  ...
  const userMenu = (
    <Menu>
      ...
      <Menu.Divider />
      <Menu.Item key="logout" icon={<LogoutOutlined />} onClick={() => navigate("/admin/login")}>
        Logout
      </Menu.Item>
    </Menu>
  )
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        >
          {collapsed ? (
            <div style={{ fontSize: "24px", fontWeight: "bold" }}>AQ</div>
          ) : (
            <div style={{ fontSize: "18px", fontWeight: "bold" }}>AdilQadri Admin</div>
          )}
        </div>
